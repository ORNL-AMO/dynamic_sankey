						...
						"<tr id='inputs'>"+
							"<td style='width:120px' class='text-center'>"+
								...
								"<div class='input-group'>"+
									...
									"<input type='text' class='form-control' aria-describedby='basic-addon1' onchange='newLabel("+numNode+")' style='width: 145px' id='label"+String(numNode)+"'>"+
								"</div>"+
								"<div class='input-group'>"+
								...
								"</div>"+
									"<input type='color' class='inp' id='nodeColor"+numNode+"' onchange = 'newNodeColor("+numNode+")' style='width: 206px'>"+
							"</td>"+
						"</tr>"+
					"</tbody>"+
				"</table>"+
						...
						"<tr id='inputs'>"+
							"<td style='width:120px' class='text-center'>"+
								...
								"<div class='input-group'>"+
									...
									"<input type='text' class='form-control' aria-describedby='basic-addon1' onchange='newSource("+numLink+")' style='width: 185px' id='source"+String(numLink)+"'>"+
								"</div>"+
								"<div class='input-group'>"+
									"<span class='input-group-addon'>Destination #</span>"+
									"<input type='text' class='form-control' aria-describedby='basic-addon1' onchange='newDest("+numLink+")' style='width: 160px' id='dest"+String(numLink)+"'>"+
								"</div>"+
								"<div class='input-group'>"+
									"<span class='input-group-addon'>Value</span>"+
									"<input type='text' class='form-control' aria-describedby='basic-addon1' onchange='newLinkVal("+numLink+")' style='width: 207px'id='linkVal"+String(numLink)+"'>"+
								"</div>"+
								"<div class='input-group'>"+
									"<span class='input-group-addon' id='basic-addon1'>Units</span>"+
									"<input type='text' class='form-control' aria-describedby='basic-addon1' onchange='updateDifference()' style='width: 210px'>"+
								"</div>"+
								"<input type='color' class='inp' id='linkColor"+numLink+"' onchange = 'newLinkColor("+numLink+")' style='width: 265px'>"+
							"</td>"+
						"</tr>"+
					"</tbody>"+
				"</table>"+
